        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-primary">
                    ...
                    <form role="form" method="POST" action="{{ route('admin.authenticate.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="" class="datepicker-input form-control" required name="date" placeholder="Date" required>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Description</label>
                                <input type="text" class="form-control" name="name" required placeholder="description">
                            </div> 
                            <div class="form-group">
