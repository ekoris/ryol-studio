            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <div class="row">
                            <div class="col-md-5">
                                <a class="btn btn-warning mb-0" href="{{ route('admin.art-work.create') }}">Create</a>
                            </div>
                                ...
                                <form class="form-inline">
                                    <div class="form-group">
                                        <select name="category_id" class="form-control" id="">
                                            ...
                                            @foreach (resolve(App\Repositories\Entities\Category::class)->where('type', CategoryType::ART_WORK)->get() as $item)
                                ...
                                <div class="card mb-4 box-shadow">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <a href="{{ route('admin.art-work.edit', $item->id) }}" class="btn btn-sm btn-info">Edit</a>
                                            <a href="{{ route('admin.art-work.delete', $item->id) }}" onclick="return confirm('Are You Sure ??')" class="btn btn-sm btn-danger">delete</a>
                                            <a href="{{ route('admin.qrcode', $item->slug) }}" target="_blank" download class="btn btn-sm btn-primary">Download QR Code</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
